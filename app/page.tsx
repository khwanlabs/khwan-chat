          ...
          {authStatus === "loading" ? (
            ...
            <div className="flex flex-col gap-1.5">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-sm border border-field-500/60 px-3 py-1.5 text-xs font-medium text-field-bright transition-colors hover:bg-field-500 hover:text-white"
              >
                {/* Google "G" mark */}
                <svg width="14" height="14" viewBox="0 0 18 18" aria-hidden className="shrink-0">
              ...
              <span className="font-mono text-[10px] leading-snug text-ink-400">
                Using demo account — sign in to load your own.
              </span>
            </div>
          )}
        </div>
